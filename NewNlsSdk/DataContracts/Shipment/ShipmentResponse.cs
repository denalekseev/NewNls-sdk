...
namespace NewNlsRemoteClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ShipmentResponse :  IEquatable<OrderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ShipmentResponse(bool? isSuccess = default(bool?), string message = default(string))
        {
